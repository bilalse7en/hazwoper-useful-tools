...
import { ArrowLeft, ArrowRight, BookOpen, Clock, RefreshCw, Mail, Sparkles, ChevronLeft, ChevronRight } from "lucide-react";
            ...
            <div className="max-w-3xl space-y-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-xl text-muted-foreground font-medium max-w-2xl leading-relaxed">
                  Deep dives into HAZWOPER automation, safety technical standards, and the future of industrial safety education.
                </p>
              </div>
            </div>
          </div>
          ...
          {loading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {Array(6).fill(0).map((_, i) => (
                <div key={i} className="h-[450px] rounded-[32px] bg-muted animate-pulse" />
              ))}
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {blogs.map((post, index) => (
                ...
                >
                  <div className="h-56 bg-muted relative overflow-hidden">
                    ...
                    <img 
                      src={post.image_url || `https://source.unsplash.com/800x600/?safety,technology&sig=${index}`} 
                      alt={post.title}
                    ...
                    <div className="mt-auto pt-6 border-t border-border/50 flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-[9px] text-muted-foreground/60 font-bold uppercase">Editorial</span>
                        </div>
                      </div>
                      <Link 
                        href={`/blog/${post.slug}`}
          ...
          <div className="relative rounded-[48px] bg-slate-950 p-12 md:p-24 overflow-hidden border border-white/5">
            ...
            <div className="relative z-10 max-w-2xl space-y-8">
              <h2 className="text-4xl md:text-5xl font-black text-white tracking-tighter leading-tight">
                Stay updated on the latest <span className="text-primary">safety tech.</span>
              </h2>
              <p className="text-slate-400 text-lg font-medium leading-relaxed">
                Join our professional circle for early access to neural updates, compliance guides, and advanced automation workflows.
              </p>

...
import { ArrowLeft, Clock, Calendar, User, Share2, Facebook, Twitter, Linkedin, AlertCircle, RefreshCw } from "lucide-react";
    ...
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 text-center space-y-8">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl font-black tracking-tight">Post Not Located</h1>
          <p className="text-muted-foreground max-w-md mx-auto">
            The editorial sequence you've requested is not present in our registry. It may have been archived or relocated.
          </p>
        </div>
        ...
        <header className="relative pt-24 pb-12 overflow-hidden border-b border-border">
          <div className="container relative z-10 mx-auto px-6">
            <div className="max-w-4xl mx-auto space-y-8 text-center md:text-left">
              <Link href="/blog" className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-widest text-muted-foreground hover:text-primary transition-colors">
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_250px] gap-16">
            ...
            <aside className="space-y-12">
               <div className="sticky top-24 space-y-12">
                  <div className="space-y-6">
                    <h3 className="text-xs font-black uppercase tracking-widest text-foreground">Share Article</h3>
                    <div className="flex flex-col gap-3">
                       <Button variant="outline" className="h-12 w-full rounded-2xl justify-start gap-3 border-border hover:bg-primary/5 hover:text-primary transition-all group">
                  ...
                  <div className="p-8 rounded-[32px] bg-primary/5 border border-primary/10 space-y-6">
                    <h3 className="text-sm font-black tracking-tight text-primary">Need Professional Content?</h3>
                    <p className="text-xs text-muted-foreground font-medium leading-relaxed">
                      Use our AI-powered generators to create course materials, blogs, and technical documentation in seconds.
                    </p>
                    <Button size="sm" className="w-full h-10 rounded-xl font-black uppercase tracking-widest text-[9px]" asChild>

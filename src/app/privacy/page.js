        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>File Uploads:</strong> When you use our document
                processing tools, you may upload DOCX, PDF, images, or video
                files. These files are processed locally in your browser and are
                not stored on our servers.
              </li>
              <li>
                <strong>Browser Storage:</strong> We use localStorage to save
                your preferences (theme settings, tool configurations) locally
                on your device.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                ...
                interactions with our website, including pages visited, features
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Provide Services:</strong> To deliver the core
                functionality of our content generation and media processing
                tools.
              </li>
              <li>
                <strong>Improve Our Services:</strong> To analyze usage patterns
          ...
          <section>
            ...
            <p>
              Google uses cookies to serve ads based on your interests. You can
            ...
            <p>
              In addition to Google AdSense, we may work with other third-party
              advertising networks that use cookies and similar technologies.
              These partners may collect information about your browsing
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Advertising Partners:</strong> Google AdSense and other
                advertising networks for ad delivery and performance
                measurement.
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              ...
              page. You can also configure your browser to reject cookies.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Since most of our tools process data locally in your browser, we
              do not retain your uploaded files or processed content on our
              servers. Browser storage data (preferences, settings) remains on
              your device until you clear it.
            </p>
            <p className="mt-3">
              Analytics and advertising data are retained according to the
              policies of our third-party providers (typically 26 months for
              Google Analytics).
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-none pl-0 space-y-2 mt-3">
              ...
              <li>
                <strong>Privacy Requests:</strong> Email us directly at the
                address above or update your consent preferences through our
                cookie banner.
              </li>
            </ul>
          </section>

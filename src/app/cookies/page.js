        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
          <section>
            ...
            <p>
              ...
              help websites remember your preferences, improve your experience,
              and provide analytics to website owners.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-card border border-border rounded-lg p-4 my-4">
              ...
              <p className="mb-2">
                <strong>Purpose:</strong> Essential for the website to function
                properly.
              </p>
              <p className="mb-2">
                <strong>Examples:</strong> Security cookies, consent preference
                cookies
              </p>
              <p className="mb-2">
              ...
              <p>
                <strong>Can be disabled:</strong> No - these are required for
                basic functionality
              </p>
            </div>
            ...
            <div className="bg-card border border-border rounded-lg p-4 my-4">
              ...
              <p className="mb-2">
                <strong>Examples:</strong> Theme selection (dark/light mode),
                language preferences, tool configurations
              </p>
              <p className="mb-2">
                <strong>Storage:</strong> Primarily uses browser localStorage,
            ...
            <div className="bg-card border border-border rounded-lg p-4 my-4">
              ...
              <p className="mb-2">
                <strong>Information collected:</strong> Pages visited, time
                spent, browser type, device information
              </p>
              <p className="mb-2">
                <strong>Duration:</strong> Up to 2 years
              </p>
              <p>
                <strong>Can be disabled:</strong> Yes - through cookie
            ...
            <div className="bg-card border border-border rounded-lg p-4 my-4">
              ...
              <p className="mb-2">
                <strong>Purpose:</strong> Serve personalized advertisements
                based on your interests.
              </p>
              <p className="mb-2">
                <strong>Provider:</strong> Google AdSense and third-party
              ...
              <p className="mb-2">
                <strong>Information collected:</strong> Browsing behavior across
                websites, ad interactions, interests
              </p>
              <p className="mb-2">
                <strong>Duration:</strong> Up to 2 years
              </p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Accept All:</strong> Consent to all cookies including
                advertising
              </li>
              <li>
            ...
            <p className="mt-3">
              You can change your preferences at any time by updating your
              consent settings.
            </p>
            ...
            <p className="mt-3">Browser-specific instructions:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <a
            ...
            <p>
              To opt out of personalized advertising from Google and other
              networks:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
          ...
          <section>
            ...
            <p>If you disable cookies, please note:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
          ...
          <section>
            ...
            <p>
              If you have questions about our use of cookies, please refer to
              our{' '}

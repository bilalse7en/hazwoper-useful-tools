    ...
    >
      <AnimatePresence mode="wait">
        {!isExpanded ? (
          ...
          >
            <span
              className={`text-lg font-black tabular-nums ${countdown !== null ? `bg-gradient-to-br ${getTimerColor()} bg-clip-text text-transparent` : 'text-foreground'}`}
            >

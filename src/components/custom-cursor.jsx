...
export function CustomCursor() {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      const currentColor = mounted
        ? glowColors[theme] || glowColors.dark
        : glowColors.dark;
  ...
  return (
    <>
      ...
      >
        <div
          className={`custom-cursor relative w-6 h-6 -left-3 -top-3 transition-transform duration-200 ${isPointer ? 'scale-150' : ''}`}
        >

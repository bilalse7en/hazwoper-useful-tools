...
export function RichTextEditor({ content, onSave, title = 'Editor' }) {
  ...
  return (
    <div
      className="bg-background dark:bg-slate-950 flex flex-col relative h-full"
      ref={toolbarRootRef}
    >
      {/* Fixed Toolbar at Top */}
      <div className="fixed left-0 right-0 z-[200] flex items-center justify-between gap-1 p-2 border-b bg-background/95 dark:bg-slate-900/95 shadow-md backdrop-blur-md px-4 py-1.5">
              ...
              {(showTableOptions || activeTable) && (
                ...
                >
                  ...
                  <div className="flex bg-white/50 rounded p-0.5">
                    <button
                      onClick={() => setTableCellAlignment('x', 'left')}
                      className="p-0.5 hover:bg-white"
                    >
                      <AlignLeft className="h-3 w-3" />
                    </button>
                    <button
                      onClick={() => setTableCellAlignment('x', 'center')}
                      className="p-0.5 hover:bg-white"
                    >
                      <AlignCenter className="h-3 w-3" />
                    </button>
                    <button
                      onClick={() => setTableCellAlignment('x', 'right')}
                      className="p-0.5 hover:bg-white"
                    >
                      <AlignRight className="h-3 w-3" />
                    </button>
                  ...
                  <div className="flex bg-white/50 rounded p-0.5 ml-0.5">
                    <button
                      onClick={() => setTableCellAlignment('y', 'top')}
                      className="p-0.5 hover:bg-white"
                    >
                      <ArrowUp className="h-3 w-3" />
                    </button>
                    <button
                      onClick={() => setTableCellAlignment('y', 'middle')}
                      className="p-0.5 hover:bg-white"
                    >
                      <MoveVertical className="h-3 w-3" />
                    </button>
                    <button
                      onClick={() => setTableCellAlignment('y', 'bottom')}
                      className="p-0.5 hover:bg-white"
                    >
        ...
        <div className="fixed left-0 right-0 z-[190] bg-gradient-to-b from-gray-50 to-transparent dark:from-gray-900 px-10 py-2 mt-14">
          <div className="flex items-center gap-4 max-w-xl mx-auto">
            ...
            <div className="text-xs text-muted-foreground">
              ...
              {featuredImageAlt && (
                <p className="opacity-70">Alt: {featuredImageAlt}</p>
              )}
            </div>
          </div>
        </div>

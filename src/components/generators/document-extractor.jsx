...
export default function DocumentExtractor() {
  ...
  const handleFileSelect = (e) => {
    ...
    if (!type) {
      setError(
        'Please upload a supported file type (.docx, .xlsx, .xls, .csv, .txt)'
      );
      return;
    }
  ...
  const handleExtract = async () => {
    ...
    try {
      ...
      setError(
        'Failed to extract content. The file might be corrupted or unsupported.'
      );
    } finally {
          ...
          <div className="glass-panel p-6 rounded-2xl border border-border">
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li className="flex items-start gap-3">
                ...
                <span>
                  <strong>Word (.docx):</strong> Preserves headings, bold,
                  italic, and lists.
                </span>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span>
                  <strong>Excel (.xlsx/xls):</strong> Converts sheets into clean
                  HTML tables.
                </span>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span>
                  <strong>Text/Code:</strong> Perfect extraction of raw strings
                  and formatting.
                </span>
              </li>
            </ul>
            ...
            {extractedText ? (
              ...
              <div className="flex-1 flex flex-col items-center justify-center py-20 text-center opacity-40">
                ...
                <p className="text-muted-foreground">
                  ...
                  <strong>Plain Text</strong> or <strong>HTML Code</strong>{' '}
                  here.
                </p>
              </div>
            )}

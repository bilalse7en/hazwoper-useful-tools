        ...
        <div className="flex flex-col items-center justify-center min-h-[45vh] w-full p-4">
          <div className="text-center space-y-4 mb-8">
            ...
            >
              {ffmpegLoaded
                ? 'Audio Studio Ready'
                : 'Spawning Native Engine...'}
            </Badge>
            <h2 className="text-4xl font-black italic tracking-tighter bg-gradient-to-r from-primary via-primary/80 to-primary/50 bg-clip-text text-transparent font-orbitron">
              AUDIO WORKSPACE
            </h2>
            <p className="text-muted-foreground max-w-xl mx-auto text-[10px] font-black tracking-[0.3em] uppercase opacity-70">
              Professional Playback Editing • Waveform Canvas
            </p>
          </div>
          ...
          <div
            className={cn(
              'w-full max-w-4xl h-[320px] rounded-[3rem] p-1 transition-all duration-500 shadow-2xl',
              editDragActive ? 'scale-[1.02]' : 'hover:scale-[1.01]'
            )}
          ...
          >
            <div
              ...
              onClick={() => ffmpegLoaded && editFileInputRef.current?.click()}
            >
              <div className="relative z-10 p-6 rounded-[2rem] bg-gradient-to-br from-primary/10 to-transparent border border-primary/10 shadow-lg group-hover:scale-110 transition-all duration-500">
                <Music className="w-12 h-12 text-primary animate-pulse" />
              </div>
              <div className="relative z-10 text-center space-y-2">
                <h2 className="text-2xl md:text-3xl font-black italic text-foreground tracking-tighter font-orbitron text-center uppercase">
                  LOAD AUDIOMASS
                </h2>
        ...
        <div className="w-full max-w-[1600px] grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 bg-card/60 backdrop-blur-3xl border border-border/50 rounded-[3rem] p-6 shadow-2xl relative overflow-hidden">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6 relative z-10">
            <div className="relative w-full rounded-[2.5rem] bg-card/30 border border-border/50 p-6 flex flex-col gap-6">
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  ...
                  {historyBuffers.length > 1 && (
                    <button
                      onClick={handleUndo}
                      className="p-1 px-3 bg-primary/10 border border-primary/20 text-primary rounded-lg text-[9px] font-black uppercase tracking-wider flex items-center gap-1.5 hover:bg-primary/20 cursor-pointer"
                    >
              ...
              {/* WAVEFORM CANVAS */}
              <div className="relative bg-background/85 rounded-[2rem] border border-border/50 p-4 shadow-inner overflow-hidden select-none hover:shadow-indigo-500/5 hover:border-violet-500/25 transition-all">
                <div className="absolute top-2 left-4 text-[8px] font-black GITHUB_FLAVORED_MARKDOWN uppercase tracking-widest text-muted-foreground/40 leading-none">
                  Drag on canvas to select trim/effect zone
                </div>
                <canvas
                  ref={canvasRef}
                  width={700}
                  ...
                  className="w-full h-[180px] cursor-col-resize block"
                />
              </div>
              ...
              <div className="flex items-center justify-between p-4 rounded-[2rem] bg-card/40 border border-border/50 shadow-inner">
                <div className="flex gap-2">
                  <Button
                    onClick={startAudio}
                    className="rounded-xl h-10 w-24 bg-primary text-primary-foreground font-black text-[10px] tracking-wider uppercase shadow-md flex items-center justify-center gap-1.5 cursor-pointer"
                  >
                    {isPlaying ? (
                      <>
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="rounded-xl h-10 w-24 border-border/50 text-[10px] font-black tracking-wider uppercase flex items-center justify-center gap-1.5 cursor-pointer"
                  >
              ...
              <div className="grid grid-cols-2 gap-4">
                <Button
                  ...
                  disabled={
                    editIsProcessing || selectionEnd - selectionStart < 0.1
                  }
                  className="h-12 rounded-xl bg-violet-600 hover:bg-violet-500 text-white font-black text-[10px] tracking-widest uppercase flex items-center justify-center gap-2 border-t border-white/20 shadow-md transition-all active:scale-95 cursor-pointer"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="h-12 rounded-xl border-2 border-border/50 text-[10px] font-black tracking-widest uppercase transition-all active:scale-95 cursor-pointer"
                >
              ...
              {/* output display */}
              {editResult && (
                <div className="mt-4 p-6 rounded-[2rem] bg-emerald-500/5 border border-emerald-500/20 flex flex-col items-center gap-6 animate-in zoom-in duration-500 font-sans">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-[10px] font-mono font-bold text-muted-foreground uppercase">
                      {editResult.fileName} • {formatFileSize(editResult.size)}
                    </p>
                  </div>
                  <audio
                    src={editResult.url}
                  ...
                  <Button
                    ...
                    className="h-12 px-10 rounded-2xl bg-emerald-600 hover:bg-emerald-500 text-white font-black uppercase tracking-widest text-[9px] shadow-lg cursor-pointer"
                  >
                    <Download className="w-4 h-4 mr-2" /> Download Encoded Audio
                  </Button>
                </div>
              )}
            </div>
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 relative z-10">
            <div className="p-8 rounded-[2.5rem] bg-card/40 border border-border/50 backdrop-blur-xl space-y-7">
              <h3 className="flex items-center gap-3 text-xs font-black uppercase tracking-[0.4em] text-muted-foreground bg-black/10 p-3 rounded-xl border border-white/5">
                <Sliders className="w-4 h-4 text-primary" /> DSP Processors
              </h3>
              ...
              {/* Reverse Toggler */}
              <div className="flex items-center justify-between p-4 rounded-xl bg-orange-500/5 border border-orange-500/20 font-sans">
                ...
                <button
                  ...
                  className={cn(
                    'text-[9px] font-black uppercase tracking-wider px-2 py-1 rounded transition-all leading-none focus:outline-none cursor-pointer',
                    reverseAudio
              ...
              <div className="space-y-3 border-t border-border pt-5">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {[
                    ...
                    <button
                      key={fmt.value}
                      onClick={() => setEditOutputFormat(fmt.value)}
                      className={cn(
                        'py-3 rounded-xl border text-[10px] font-black transition-all cursor-pointer',
                        editOutputFormat === fmt.value
              ...
              <div className="pt-4">
                <ProgressButton
                  ...
                  disabled={editIsProcessing || !ffmpegLoaded}
                  isLoading={editIsProcessing}
                  progress={editProgress}
                  label="Apply Audio Filters"
                  loadingLabel="Rendering Waveform..."
                  className="h-14 w-full rounded-2xl bg-gradient-to-r from-primary to-primary/80 text-primary-foreground font-black uppercase tracking-[0.2em] shadow-xl cursor-pointer"
                />
              </div>
            </div>
            ...
            <Button
              ...
              className="h-14 rounded-2xl border-2 border-border/50 text-[10px] font-black uppercase tracking-[0.3em] cursor-pointer"
            >

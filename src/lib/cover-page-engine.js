...
export async function generateCoverPagePdf() {
  ...
  page.drawText(
    'Industrial Safety. Regulatory Compliance. Workforce Protection.',
    {
      x: 18,
      y: H - 68,
      size: 7.5,
  ...
  addLinkAnnotation(
    pdfDoc,
    page,
    [rightMargin - phoneW - 24, phoneY - 4, rightMargin, phoneY + 12],
    'tel:1-866-429-6742'
  );
  ...
  const subtitle =
    'Your Trusted Partner in Industrial Safety & Regulatory Compliance';
  ...
  curY = drawSectionHeading(
    page,
    'OUR TRAINING & COMPLIANCE SOLUTIONS',
    marginX,
    curY,
    fontBold
  );
  ...
  curY = drawSectionHeading(
    page,
    '24/7 WORKFORCE SUPPORT & CONSULTATION',
    marginX,
    curY,
    fontBold
  );
  ...
  addLinkAnnotation(
    pdfDoc,
    page,
    [footCol1X, 40, footCol1X + 170, footerH - 15],
  ...
  addLinkAnnotation(
    pdfDoc,
    page,
    [footCol2X, 40, footCol2X + 160, footerH - 15],
    'https://hazwoper-osha.com/online-courses'
  );
  ...
  page.drawSvgPath(
    `M ${addrX + 3} ${footerH - 21} L ${addrX + 7} ${footerH - 14} L ${addrX + 11} ${footerH - 21} Z`,
    {
      color: BLACK,
    }
  );

...
export const blogPosts = [
  ...
  },
  {
    ...
    readTime: '7 min read',
    content: `
      <p>FAQs are often an afterthought in course development, yet they are one of the most critical components for student success in technical subjects like HAZWOPER. A well-designed FAQ section doesn't just answer questions—it anticipates confusion and clarifies complex regulatory language.</p>
  ...
  },
  {
    ...
    readTime: '9 min read',
    content: `
      <p>Safety training is a right, not a privilege. Ensuring that your online course materials are accessible to workers with disabilities is not just a legal requirement under the ADA—it's a fundamental safety priority.</p>
